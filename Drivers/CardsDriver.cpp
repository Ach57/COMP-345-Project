...
void testCards()
{
    ...
    cout << " Player's hand after drawing 5 cards: " << hand1 << '\n';
    cout << " Deck after drawing 5 cards: " << deck << '\n';

    cout << " Playing the 3rd card in player's hand...\n";
    hand1.playCard(2, player1, ordersList, deck);

    cout << " Player's hand after playing 3rd card: " << hand1 << '\n';
    cout << " Deck after playing 3rd card: " << deck << '\n';

    cout << " Orders created by played cards:\n";
    ordersList.print();
